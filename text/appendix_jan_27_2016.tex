...
\spacingset{2} We quantify the bias in estimating the average number
...
fatality rates.  \tcb{If all individuals in a birth cohort have died, we
could compare period life expectancy and cohort life expectancy.  The
former summarizes the mortality experience of a hypothetical cohort
subjected$-$over its entire life$-$to the fatality rates of a specific
year (period).  The latter summarizes the mortality experience of the
actual birth cohort subjected to its observed fatality rates.  In our
analysis, some individuals in the birth cohorts are still alive in
2002 (i.e., the birth cohorts are not extinct).  Thus we cannot
calculate cohort life expectancy and compare it to period life
expectancy.  To overcome this constraint, we calculate period and
cohort {\it temporary life expectancy}, which equals the total number
of person-years lived between ages $a_1$ and $a_2$ in a life table
based on a set of period and cohort fatality rates, respectively.}

% Although the cohort-based approach captures the true mortality
% experience of the cohort, cohort life expectancy can only be
% calculated retrospectively once the entire cohort has died.  \tcb{To
%   overcome this inherent constraint of cohort life expectancy, we
%   calculate {\it temporary life expectancy}, which equals the total
%   number of person-years lived between ages $a_1$ and $a_2$ in a life
%   table based on a set of fatality rates.}

First, consider the hypothetical cohort of the period 1975, which aged
over time along the black vertical line shown in
Figure~\ref{fig:Lexis}.  Its period-based fatality rates are shown
along this vertical line and the resulting temporary life expectancy
equaled 16.32 years.  
\begin{figure}[h]
\begin{center}
\includegraphics[width=\linewidth]{appendix_figure3}
\spacingset{1}\caption{Lexis diagram of 1975 period fatality rates and
  1931-1935 cohort fatality rates.}
\label{fig:Lexis}
\end{center}
\end{figure}

Second, consider the birth cohort of 1931-1935, which aged over time
along the black diagonal line shown in Figure~\ref{fig:Lexis}.  In
other words, the 1931-1935 birth cohort was 40-44 years old in 1975
and 65-69 years old in 2002.  Its cohort-based fatality rates are
shown along this diagonal line and the resulting temporary life
expectancy equaled 17.77 years.  The 1931-1935 cohort temporary life
expectancy is larger than the 1975 period temporary life expectancy
because the fatality rates of the former are smaller than those of the
latter.
 
Next, consider the hypothetical cohort of the period 2002, which aged
over time along the gray vertical line shown in
Figure~\ref{fig:Lexis}.   Its period-based fatality rates are shown
along this vertical line and the resulting temporary life expectancy
equaled  23.16 years.  

Finally, consider the birth cohort of 1958-1962, which was 40-44 years
old in 2002.  We cannot observe the cohort-based fatality rates of
this birth cohort beyond 2002; 2002 is the final year in our analysis
with 10 years of follow-up.  Thus, we assumed that this birth cohort
will experience mortality improvements similar to that of the
1931-1935 birth cohort between 1975 and 2000. Specifically, we
multiply the 2002 period fatality rates by the proportionate
reductions by age group between the 1975 period fatality rates and the
1931-1935 birth cohort fatality rates.  We assume the reductions
observed in the earlier period and birth cohort apply to the later
period and birth cohort because age-group-specific fatality rates have
declined approximately linearly since about 1980.  Based on this
assumption, the temporary life expectancy for the 1958-1962 birth
cohort equaled 24.12 years.
(Figure~\ref{fig:age_specific}).
\begin{figure}[h]
\begin{center}
\includegraphics[width=\linewidth]{age_specific_case_fatality_rates}
\spacingset{1}\caption{Time Trends in Age-Group-Specific Case Fatality Rates.}
\label{fig:age_specific}
\end{center}
\end{figure}

Finally, we examine the gain in temporary life expectancy between the
1975 and 2002 period versus the gain between the 1931-1935 and
1958-1962 birth cohorts.  The period-based life expectancy increased
by 6.83 years (from 16.32 years in 1975 to 23.16 years in 20020.  The
cohort-baesd life expectancy increased by 6.35 years (from 17.77 years
for the 1931-1935 birth cohort to 24.12 years for the 1958-1962 birth
cohort).  Thus, our use of period-based fatality rates likely provides
an upper bound to the true, or cohort-based, gain in life expectancy.

% Period life expectancy summarizes the mortality experience of a
% hypothetical cohort subjected$-$over its entire life$-$to the fatality
% rates of a specific year (period).  For example, the period-based
% fatality rates of 1975 are shown along the vertical line in
% Figure~\ref{fig:Lexis}.  

% \tcr{We cannot estimate cohort life expectancy because not all
%   individuals have died, instead} we compute {\it temporary life
...
% (year\tcr{s} 1975 \tcr{and 2002}) and cohort (birth cohort 1931-1935
% \tcr{and 1958-1962}) fatality rates.  \tcr{The goal of this exercise
%   is to compare the gain in temporary life expectancy when using
%   period vs. cohort fatality rates to assess the bias in the gain in
%   life expectancy.}

% \tcr{Results indicate that} The temporary life expectancy equaled 16.32 years based
% on 1975 period fatality rates and 17.77 years based on 1931-1935 birth
% cohort fatality rates.

% To estimate fatality rates of the 1958-1962 birth cohort (which was
% 40-44 years old in 2002), \tcr{we assumed that this cohort will
%   experience a mortality improvement similar to that of the 1931-1935
...
% \tcr{Under these assumptions,} Temporary life expectancy equaled 23.16 years based on 2002 period
% fatality rates and 24.12 years based on 1958-1962 estimated birth
% cohort fatality rates.  Thus, the gain in cohort-based temporary life
% expectancy between the 1931-1935 and 1958-1962 birth cohorts equaled
% 6.35 years, and the gain in period-based temporary life expectancy
% between 1975 and 2002 equaled 6.83 years.  Thus, our use of
% period-based fatality rates likely provides an upper bound to the
% true, or cohort-based, gain in life expectancy.

% We provide a sense of bias when using period life expectancy rather
% than cohort by estimating the average number of years lived using
% period and cohort fatality rates. An important limitation of cohort
% life expectancy is that it can only be computed after all individuals
% have died. For the SEER register data, for example, this limits the
% cohorts for which cohort life expectancy can be computed. For example,
% Figure \ref{fig:Lexis} plots cohorts of newly diagnosed patients in
% 1975 with shaded areas representing the aging of each cohort over
% time. For this exercise we focus on the 1930-34 cohort because this
% the only cohort that includes patients aged 40-44. This cohort can be
% followed for 35 years (from 1975 to 2010) so the cohort survivors
% reached 75-79 years of age in 2010. We cannot estimate life expectancy
% for this cohort because not all individuals have died, we thus
% estimated the average number of years lived between ages 40 to 79 as a
% proxy for cohort life expectancy.


% For this computation we estimate case fatality rates by age for the
% 1930-34 cohort as it ages over time. We input these rates into a
% life table and compute the average number of years lived between
% ages 40 to 79. We follow similar procedure for period case fatality
% rates by age from 1975. We then compare these estimates and found
% that cohort average years of life are about \#\% higher than period.
